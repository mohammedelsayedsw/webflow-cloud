// "use client"; // was required by devlink components

// import { Section, Block, Link } from "@/devlink/_Builtin";

export default function Home() {
  return (
    /* <Section tag="section" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}> */
    <section
      style={{
        minHeight: "100vh",
        display: "flex",
    ...
    >
      ...
      <div className="container">
        {/* <Block tag="div" className="hero-split" style={{ textAlign: "center", maxWidth: "600px", margin: "0 auto" }}> */}
        <div
        ...
        >
          ...
          <div style={{ marginTop: "12px" }}>
            {/* <Link button={true} options={{ href: "https://developers.webflow.com/webflow-cloud/getting-started" }} className="button-primary" style={{...}}> */}
            <a
